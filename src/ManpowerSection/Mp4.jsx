        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="relative bg-secondary text-primary cursor-follow p-8 rounded-3xl overflow-hidden min-h-[300px] lg:row-span-2 flex flex-col justify-start group">
            ...
            <img 
              ...
              className="absolute opacity-70 z-0 w-[100%] max-w-[900px] -right-12 -bottom-16 transform transition-transform duration-300 group-hover:scale-105"
            />
          </div>
          ...
          <div className="relative bg-secondary text-primary cursor-follow p-8 rounded-3xl overflow-hidden min-h-[300px] flex flex-col group justify-end">
            <img 
              ...
              className="absolute opacity-70 z-0 w-[75%] max-w-[400px] -right-8 -top-10 lg:-right-10 transform transition-transform duration-300 group-hover:scale-105"
            />
            <div className="relative z-10 w-full mt-auto">
              <h3 className="text-2xl font-bold mb-3">{industrySectors[1].title}</h3>
              <p className="text-primary font-medium w-full lg:w-4/5">{industrySectors[1].description}</p>
            </div>
          </div>
          ...
          <div className="relative bg-secondary text-primary cursor-follow p-8 rounded-3xl overflow-hidden min-h-[300px] flex flex-col group justify-start">
            ...
            <img 
              ...
              className="absolute opacity-70 z-0 w-[60%] max-w-[390px] -right-9 -bottom-6 transform transition-transform duration-300 group-hover:scale-105"
            />
          </div>
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="relative bg-secondary text-primary cursor-follow p-8 rounded-3xl overflow-hidden min-h-[300px] flex flex-col group justify-end">
              <img 
                ...
                className="absolute opacity-70 z-0 w-[95%] max-w-[310px] -right-8 -top-8 transform transition-transform duration-300 group-hover:scale-105"
              />
              <div className="relative z-10 w-full mt-auto">
                <h3 className="text-2xl font-bold mb-3">{industrySectors[3].title}</h3>
                <p className="text-primary font-medium">{industrySectors[3].description}</p>
              </div>
            </div>
            ...
            <div className="relative bg-secondary text-primary cursor-follow p-8 rounded-3xl overflow-hidden min-h-[300px] flex flex-col group justify-end">
              <img 
                ...
                className="absolute opacity-70 z-0 w-3/5 max-w-[330px] -right-10 -bottom-8 transform transition-transform duration-300 group-hover:scale-105"
              />
              <div className="relative z-10 w-full mt-auto">
                <h3 className="text-2xl font-bold mb-3">{industrySectors[4].title}</h3>
                <p className="text-primary font-medium">{industrySectors[4].description}</p>
              </div>
            </div>
          </div>
        </div>
