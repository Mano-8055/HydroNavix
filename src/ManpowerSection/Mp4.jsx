...
const Mp4 = () => {
  ...
  return (
    <section className="px-4 sm:px-6 lg:px-8 py-20 bg-[#f0f2f5]">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-[#003d4d]">
            INDUSTRY SECTORS COVERED
          </h2>
          <p className="text-[#003d4d]/70 mt-4 max-w-2xl mx-auto text-lg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Card 1 (Tall) */}
          <div className="relative bg-[#1c1c1e] text-white p-8 rounded-3xl overflow-hidden min-h-[300px] lg:row-span-2 flex flex-col justify-start">
            <div className="w-full lg:w-3/5">
              <h3 className="text-3xl font-bold mb-4">{industrySectors[0].title}</h3>
              <p className="text-gray-400">{industrySectors[0].description}</p>
            </div>
            <img 
              src={industrySectors[0].image} 
              alt={industrySectors[0].title} 
              className="absolute w-4/5 lg:w-full max-w-xs lg:max-w-md -right-10 -bottom-10 lg:-right-16 lg:-bottom-16 transform transition-transform duration-300 hover:scale-105"
            />
          </div>

          {/* Card 2 (Short) */}
          <div className="relative bg-[#1c1c1e] text-white p-8 rounded-3xl overflow-hidden min-h-[300px] flex flex-col justify-end">
             <img 
              src={industrySectors[1].image} 
              alt={industrySectors[1].title} 
              className="absolute w-1/2 max-w-xs -right-8 -top-8 lg:-right-10 lg:-top-12 transform transition-transform duration-300 hover:scale-105"
            />
            <div className="w-full mt-auto">
              <h3 className="text-2xl font-bold mb-3">{industrySectors[1].title}</h3>
              <p className="text-gray-400 w-full lg:w-4/5">{industrySectors[1].description}</p>
            </div>
          </div>
          
          {/* Card 3 (Short) */}
          <div className="relative bg-[#1c1c1e] text-white p-8 rounded-3xl overflow-hidden min-h-[300px] flex flex-col justify-start">
            <div className="w-full lg:w-4/5">
              <h3 className="text-2xl font-bold mb-3">{industrySectors[2].title}</h3>
              <p className="text-gray-400">{industrySectors[2].description}</p>
            </div>
            <img 
              src={industrySectors[2].image} 
              alt={industrySectors[2].title} 
              className="absolute w-1/2 max-w-[180px] -right-4 -bottom-4 transform transition-transform duration-300 hover:scale-105"
            />
          </div>
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="relative bg-[#1c1c1e] text-white p-8 rounded-3xl overflow-hidden min-h-[300px] flex flex-col justify-end">
              <img 
                ...
                className="absolute w-1/2 max-w-[200px] -right-8 -top-8 transform transition-transform duration-300 hover:scale-105"
              />
              <div className="w-full mt-auto">
                <h3 className="text-2xl font-bold mb-3">{industrySectors[3].title}</h3>
                <p className="text-gray-400">{industrySectors[3].description}</p>
              </div>
            </div>
            ...
            <div className="relative bg-[#1c1c1e] text-white p-8 rounded-3xl overflow-hidden min-h-[300px] flex flex-col justify-end">
              <img 
                ...
                className="absolute w-3/5 max-w-[240px] -right-10 -bottom-8 transform transition-transform duration-300 hover:scale-105"
              />
              <div className="w-full mt-auto">
                <h3 className="text-2xl font-bold mb-3">{industrySectors[4].title}</h3>
                <p className="text-gray-400">{industrySectors[4].description}</p>
              </div>
            </div>
          </div>
        </div>
